...
make(exports, 'transferMessage', function (deviceType, deviceId, openid, content, callback) {
  ...
  var url = 'https://api.weixin.qq.com/device/transmsg?access_token=' + this.token.accessToken;
  var info = {
...
make(exports, 'createDeviceQRCode', function (deviceIds, callback) {
  ...
  var url = 'https://api.weixin.qq.com/device/create_qrcode?access_token=' + this.token.accessToken;
  var info = {
...
make(exports, 'getDeviceQRCodeNew', function (product_id, callback) {
  // https://api.weixin.qq.com/device/create_qrcode?access_token=ACCESS_TOKEN
  var url = 'https://api.weixin.qq.com/device/getqrcode?access_token=' + this.token.accessToken + '&product_id=' + product_id;
...
make(exports, 'getDeviceQRCode', function (devices, optype, callback) {
  ...
  var url = 'https://api.weixin.qq.com/device/getqrcode?access_token=' + this.token.accessToken;
  this.request(url, {dataType: 'json'}, wrapper(callback));
});
...
make(exports, 'bindDevice', function (deviceId, openid, ticket, callback) {
  ...
  var url = 'https://api.weixin.qq.com/device/bind?access_token=' + this.token.accessToken;
  var data = {
    ticket: ticket,
    device_id: deviceId,
    openid: openid
...
make(exports, 'unbindDevice', function (deviceId, openid, ticket, callback) {
  ...
  var url = 'https://api.weixin.qq.com/device/unbind?access_token=' + this.token.accessToken;
  var data = {
    ticket: ticket,
    device_id: deviceId,
    openid: openid
...
make(exports, 'compelBindDevice', function (deviceId, openid, callback) {
  ...
  var url = 'https://api.weixin.qq.com/device/compel_bind?access_token=' + this.token.accessToken;
  var data = {
    device_id: deviceId,
    openid: openid
  };
...
make(exports, 'compelUnbindDevice', function (deviceId, openid, callback) {
  ...
  var url = 'https://api.weixin.qq.com/device/compel_unbind?access_token=' + this.token.accessToken;
  var data = {
    device_id: deviceId,
    openid: openid
  };
...
make(exports, 'getDeviceStatus', function (deviceId, callback) {
  ...
  var url = 'https://api.weixin.qq.com/device/get_stat?access_token=' + this.token.accessToken + "&device_id=" + deviceId;
  this.request(url, {dataType: 'json'}, wrapper(callback));
});
...
make(exports, 'verifyDeviceQRCode', function (ticket, callback) {
  ...
  var url = 'https://api.weixin.qq.com/device/verify_qrcode?access_token=' + this.token.accessToken;
  var data = {
    ticket: ticket,
  };
  this.request(url, postJSON(data), wrapper(callback));
...
make(exports, 'getOpenID', function (deviceId, deviceType, callback) {
  ...
  var url = 'https://api.weixin.qq.com/device/get_openid?access_token=' + this.token.accessToken + "&device_id=" + deviceId + "&device_type=" + deviceType;
  this.request(url, {dataType: 'json'}, wrapper(callback));
});
...
make(exports, 'getBindDevice', function (openid, callback) {
  ...
  var url = 'https://api.weixin.qq.com/device/get_bind_device?access_token=' + this.token.accessToken + "&openid=" + openid;
  this.request(url, {dataType: 'json'}, wrapper(callback));
});
