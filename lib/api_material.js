...
exports._uploadMaterial = function (filepath, type, callback) {
  ...
  fs.stat(filepath, function (err, stat) {
    ...
    var url = that.fileServerPrefix + 'material/add_material?access_token=' + that.token.accessToken + '&type=' + type;
    var opts = {
      dataType: 'json',
      type: 'POST',
      timeout: 60000, // 60秒超时
...
exports._uploadVideoMaterial = function (filepath, description, callback) {
  ...
  fs.stat(filepath, function (err, stat) {
    ...
    var url = that.fileServerPrefix + 'material/add_material?access_token=' + that.token.accessToken + '&type=video';
    var opts = {
      dataType: 'json',
      type: 'POST',
      timeout: 60000, // 60秒超时
...
exports._getMaterial = function (mediaId, callback) {
  ...
  var opts = postJSON({'media_id': mediaId});
