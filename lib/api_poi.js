// 微信门店接口, 当前版本基于《POI 门店管理接口文档 V2.2.3》
// 文档请参考(内置于微信卡券接口文档)：http://mp.weixin.qq.com/wiki/9/d8a5f3b102915f30516d79b44fe665ed.html
 ...
 * Examples:
 * ```
 * api.uploadImg('filepath', callback);
 * ```
 * Callback:
 *
 * - `err`, 调用失败时得到的异常
 ...
 *  "errcode": 0,
 *  "errmsg": "ok",
 *  "url": "http://mmbiz.qpic.cn/mmbiz/tKa6zibWq0kWzIvvTNVibmG3icW5dA25elD07vDeibONZGC9Gv7PgKz9QG51Mv3FicwZzHNwqK8jSuiatLTic6Cjic51JQ/0"
 * }
 * ```
 *
 ...
 */
make(exports, 'uploadImg', function (filepath, callback) {
  var that = this;
...
make(exports, 'addPoi', function (poi, callback) {
  ...
  var url = this.prefix + 'poi/addpoi?access_token=' + this.token.accessToken;
...
make(exports, 'getPoi', function (poiId, callback) {
  var url = this.prefix + 'poi/getpoi?access_token=' + this.token.accessToken;
  var data = {
    poi_id: poiId
  };
  this.request(url, postJSON(data), wrapper(callback));
...
make(exports, 'getPois', function (begin, limit, callback) {
  var url = this.prefix + 'poi/getpoilist?access_token=' + this.token.accessToken;
  var data = {
    begin: begin,
    limit: limit
  };
...
make(exports, 'delPoi', function (poiId, callback) {
  var url = this.prefix + 'poi/delpoi?access_token=' + this.token.accessToken;
  var data = {
    poi_id: poiId
  };
  this.request(url, postJSON(data), wrapper(callback));
...
make(exports, 'updatePoi', function (poi, callback) {
  ...
  var url = this.prefix + 'poi/updatepoi?access_token=' + this.token.accessToken;
  this.request(url, postJSON(data), wrapper(callback));
});
