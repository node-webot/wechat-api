...
make(exports, 'applyBeaconsStatus', function (apply_id, callback) {
  ...
  var url = 'https://api.weixin.qq.com/shakearound/device/applystatus?access_token=' + this.token.accessToken;
...
make(exports, 'searchBeaconPageRelation', function (options, callback) {
  var url = 'https://api.weixin.qq.com/shakearound/relation/search?access_token=' + this.token.accessToken;
  this.request(url, postJSON(options), wrapper(callback));
});
...
make(exports, 'getDeviceStatisticsList', function (options, callback) {
  var url = 'https://api.weixin.qq.com/shakearound/statistics/devicelist?access_token=' + this.token.accessToken;
  this.request(url, postJSON(options), wrapper(callback));
});
...
make(exports, 'getPageStatisticsList', function (options, callback) {
  var url = 'https://api.weixin.qq.com/shakearound/statistics/pagelist?access_token=' + this.token.accessToken;
  this.request(url, postJSON(options), wrapper(callback));
});
...
make(exports, 'listBeaconGroup', function (options, callback) {
  var url = 'https://api.weixin.qq.com/shakearound/device/group/getlist?access_token=' + this.token.accessToken;
  this.request(url, postJSON(options), wrapper(callback));
});
...
make(exports, 'queryGroupBeacons', function (options, callback) {
  var url = 'https://api.weixin.qq.com/shakearound/device/group/getdetail?access_token=' + this.token.accessToken;
  this.request(url, postJSON(options), wrapper(callback));
});
...
make(exports, 'addBeaconGroup', function (group, callback) {
  var url = 'https://api.weixin.qq.com/shakearound/device/group/add?access_token=' + this.token.accessToken;
...
make(exports, 'updateBeaconGroup', function (group, callback) {
  var url = 'https://api.weixin.qq.com/shakearound/device/group/update?access_token=' + this.token.accessToken;
  this.request(url, postJSON(group), wrapper(callback));
});
...
make(exports, 'deleteBeaconGroup', function (group_id, callback) {
  ...
  var url = 'https://api.weixin.qq.com/shakearound/device/group/delete?access_token=' + this.token.accessToken;
  this.request(url, postJSON(data), wrapper(callback));
});
...
make(exports, 'addGroupBeacons', function (options, callback) {
  var url = 'https://api.weixin.qq.com/shakearound/device/group/adddevice?access_token=' + this.token.accessToken;
  this.request(url, postJSON(options), wrapper(callback));
});
...
make(exports, 'deleteGroupBeacons', function (options, callback) {
  var url = 'https://api.weixin.qq.com/shakearound/device/group/deletedevice?access_token=' + this.token.accessToken;
  this.request(url, postJSON(options), wrapper(callback));
});
...
make(exports, 'setPrizeBucket', function (options, callback) {
  var url = 'https://api.weixin.qq.com/shakearound/lottery/setprizebucket?access_token=' + this.token.accessToken;
  this.request(url, postJSON(options), wrapper(callback));
});
...
make(exports, 'setLotterySwitch', function (lotteryId, onoff, callback) {
  var url = 'https://api.weixin.qq.com/shakearound/lottery/setlotteryswitch?lottery_id=' + lotteryId + '&onoff=' + onoff + '&access_token=' + this.token.accessToken;
