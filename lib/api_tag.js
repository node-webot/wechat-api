...
exports._createTag = function (name, callback) {
  ...
  var url = this.prefix + 'tags/create?access_token=' + this.token.accessToken;
  var data = {
    'tag': {
      'name': name
    }
...
exports._getTags = function (callback) {
  ...
  var url = this.prefix + 'tags/get?access_token=' + this.token.accessToken;
...
exports._editTag = function (id, name, callback) {
  ...
  var url = this.prefix + 'tags/update?access_token=' + this.token.accessToken;
  var data = {
    "tag": {
      "id": id,
       "name": name 
...
exports._deleteTag = function (id, callback) {
  ...
  // POST数据格式：json
  // POST数据例子：{"tag":{"id":108}}
  var url = this.prefix + 'tags/delete?access_token=' + this.token.accessToken;
  var data = {
    "tag": {"id": id}
  };
  this.request(url, postJSON(data), wrapper(callback));
...
exports._getTagUsers = function (tagId, openid, callback) {
  ...
  var url = this.prefix + 'user/tag/get?access_token=' + this.token.accessToken;
  var data = {
    "tagid": tagId,
    "next_openid": openid
  };
...
exports._membersBatchtagging = function (tagId, openList, callback) {
  ...
  var url = this.prefix + 'tags/members/batchtagging?access_token=' + this.token.accessToken;
  var data = {
...
exports._membersBatchuntagging = function (tagId, openList, callback) {
  ...
  var url = this.prefix + 'tags/members/batchuntagging?access_token=' + this.token.accessToken;
  var data = {
    "openid_list":openList, 
    "tagid": tagId
  };
...
exports._getUserTags = function (openid, callback) {
  ...
  var url = this.prefix + 'tags/getidlist?access_token=' + this.token.accessToken;
  var data = {
    "openid":openid 
  };
  this.request(url, postJSON(data), wrapper(callback));
