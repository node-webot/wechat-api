...
exports._createCustomMenu = function (menu, callback) {
  var url = this.prefix + 'menu/addconditional?access_token=' + this.token.accessToken;
...
exports._removeCustomMenu = function (menu_id,callback) {
  var url = this.prefix + 'menu/delconditional?access_token=' + this.token.accessToken;
...
exports._testCustomMenu = function (user_id,callback) {
  var url = this.prefix + 'menu/trymatch?access_token=' + this.token.accessToken;
  this.request(url, postJSON({
    "user_id" : user_id
  }), wrapper(callback));
};
